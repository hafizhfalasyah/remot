...
<main>
    <div class="head-title">
        ...
        <ul class="breadcrumb">
            ...
            <li>
            <a class="active" href="{{ url('/rent-list') }}">Daftar Data Pengguna</a>
            </li>
            <li><i class='bx bx-chevron-right'></i></li>
            <li>
            <a class="active" href="{{ url('/add-rent') }}">Tambah Data Pengguna</a>
            </li>
        </ul>
        </div>
    </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            @endif
            <form method="POST" action="{{ url('save-user') }}" class="rent-form">
                @csrf
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="contoh@gmail.com" value="{{ old('email') }}">
                    @error('email')
                        <div class="text-danger">
                            <i class="bx bx-error-circle error-icon"></i>
                            {{ $message }}
